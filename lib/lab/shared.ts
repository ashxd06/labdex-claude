 ...
 * protegidas por RLS exigiendo `authenticated`, así que este cliente sigue
 * siendo el de la sesión del usuario — nunca la service role key.
 */
 ...
 * lectura pública. Esta comprobación se ejecuta en el servidor en cada
 * página del módulo (además de la exigida por el middleware y, en última
 * instancia, por las políticas RLS de Postgres).
 */
