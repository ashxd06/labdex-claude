      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:px-6 lg:px-8">
        <Breadcrumbs
          items={[
            ...
            { label: "Análisis clínicos", href: "/contenido/analisis" },
            { label: item.name },
          ]}
        />
        ...
        <div className="mt-6">
          <ResourceDetailSections resourceKey="clinical_analyses" record={item as unknown as Record<string, unknown>} />
        </div>

        {!item.reference_range && (
          <p className="mt-4 text-sm text-text-faint">
            Valores de referencia no disponibles.
          </p>
        )}
      </main>
      <Footer />
