    ...
    <div className="min-h-dvh bg-bg">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
            ...
            <p className="mt-2 max-w-xl text-sm text-text-faint">
              Fase 1: fundación de la plataforma. La base de conocimiento
              científica y las herramientas de laboratorio se incorporarán en
              las próximas fases.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-sm text-text-faint">Módulos en construcción</span>
          </div>
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-8 text-sm text-text-faint sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <span className="font-mono text-xs">Fase 1 · Fundación del proyecto</span>
        </div>
      </footer>
    </div>
  );
